...
function generateHtml(title, tech, img, gh = "#", lnk = "#",demo="#"){
    ...
    if(demo != "#"){
        you_shiz = `<a href="` + lnk + `"><i class="fa fa-link fa-3x"></i></a><br/>`
    }
    if(demo != "#"){
        you_shiz2 = `<a> Demo Link </a>`
    }
    if(lnk_shiz != "" || gh_shiz != "" || ){
        social_shiz = `<div class="social_icon">` + gh_shiz + gh_shiz2 + '<br/>' +lnk_shiz + lnk_shiz2 +'<br/>' +you_shiz + you_shiz2 +
        `</div>`;
    }
